    ...
    <div class="p-2 bd-highlight">
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav bg-white mr-auto ">
                ...
                <li class="nav-item">
                    <a href="#contactus">
                        <button class="contactus-nav nav-item btn btn-info btn-lg rounded-pill">Contact</button></a>
                </li>
            </ul>
        </div>
    </div>
...
<section class="services d-flex align-items-center" id="service">
    <div class="container-fluid">
        ...
        <div class="row justify-content-around">
            ...
            <!-- CARD DESIGN -->
            <div class="card border-0" style="width: 20rem; padding-bottom:10px;">
...
<section id="ourwork">
    <div class="container-fluid" id="ourwork">
        ...
        <div class="mybtn d-flex justify-content-center">
            <a href="{{ url('/gallery') }}" >
            <button" class="btn btn-outline-info rounded-0">Mai multe...</button></a>
        </div>
    </div>
</section>
